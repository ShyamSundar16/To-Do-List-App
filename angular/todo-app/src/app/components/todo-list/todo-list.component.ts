...
export class TodoListComponent implements OnInit, AfterViewInit {
  ...
  getTasks() {
    // const sampleTasks = [
    //   { id: 1, title: 'Task 1', description: 'Description for Task 1', effortRequired: 1, category: 'Developement', status: 'IN_PROGRESS', startDate: '21/08/24', endDate: '29/08/24', isFavorite: false },
